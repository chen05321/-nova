...
// 返回 OpenAI/DeepSeek 兼容的 Function Calling 工具定义
      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            file: { type: 'string', description: 'File path (alias)' },
      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            cmd: { type: 'string', description: 'Shell command (alias)' }
          }
        }
      }
    },
      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            path: { type: 'string', description: 'URL (alias)' }
          }
        }
      }
    },
